...
function headerBoxOne_widgets_init() {
    register_sidebar( array(
        'name' => __( 'Header Box One', 'headerBoxOne' ),
        'id' => 'header-box-one',
        'before_widget' => '<div class="widgetOne">',
        'after_widget' => '</div>',
        'before_title' => '<h4>',
        'after_title' => '</h4>',
    ) );
}
add_action( 'widgets_init', 'headerBoxOne_widgets_init' );

function headerBoxTwo_widgets_init() {
    register_sidebar( array(
        'name' => __( 'Header Box Two', 'headerBoxTwo' ),
        'id' => 'header-box-two',
        'before_widget' => '<div class="widgetTwo">',
        'after_widget' => '</div>',
        'before_title' => '<h4>',
        'after_title' => '</h4>',
    ) );
}
add_action( 'widgets_init', 'headerBoxTwo_widgets_init' );

function headerBoxThree_widgets_init() {
    register_sidebar( array(
        'name' => __( 'Header Box Three', 'headerBoxThree' ),
        'id' => 'header-box-three',
        'before_widget' => '<div class="widgetThree">',
        'after_widget' => '</div>',
        'before_title' => '<h4>',
        'after_title' => '</h4>',
    ) );
}
add_action( 'widgets_init', 'headerBoxThree_widgets_init' );
